...
def main():
  ...
  ap.add_argument("--epochs", required=False, default=50,
                  help="how many training epochs? (default: 50)")
  ap.add_argument("--training-steps", required=False, default=100,
                  help="how many steps per training epoch? (default: 100)")
  ap.add_argument("--n-workers", required=False, default=4,
                  help="how many parallel workers to use to load data? (default: 4)")
  ap.add_argument("--validation-steps", required=False, default=100,
